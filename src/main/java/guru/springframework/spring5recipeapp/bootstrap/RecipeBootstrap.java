...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    private List<Recipe> getRecipes()
    {
        ...
        guacRecipe.addIngredient(new Ingredient("serrano chillis, stems and seeds removed, minced", new BigDecimal(2), eachUOM));
    ...
    private UnitOfMeasure getUnitOfMeasure(String description)
    {
        return unitOfMeasureRepository
                ...
                .orElseThrow(() -> new RuntimeException("Unit of Measure " + description + " does not exist"));
    }
    ...
    private Category getCategory(String description)
    {
        return categoryRepository
                .findByDescription(description)
                .orElseThrow(() -> new RuntimeException("Category " + description + " does not exist"));
    }
}
